...
** Feldspar
   ...
   expression similar to $1+n$ by replacing it with the value $n$. The
   exact modifications can be found in \autoref{appendix:feldspar}.
   The bug was quickly discovered by the procedure and several
   counterexamples were produced.
