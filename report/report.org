...
*** Matching functions
    ...
    make sense in several EDSL's, for instance Feldspar
    \cite{feldspar}.

    \todo{A more specific Feldspar reference? Ask emax}
...
** Template Haskell
   ...
   Haskell function =defineLanguage= that a user can use to construct
...
** Summary
   ...
   showed how to use the functions introduced in \ref{sec:impl} to
